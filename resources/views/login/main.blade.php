...
@section('head')
    <title>Login - Control de avance</title>
@endsection
        ...
        <div class="block xl:grid grid-cols-2 gap-4">
            ...
            <div class="hidden xl:flex flex-col min-h-screen">
                ...
                <div class="my-auto">
                    ...
                    <div class="-intro-x text-white font-medium text-4xl leading-tight mt-10">Control de avances <br> Administra tus actividades</div>
                    <div class="-intro-x mt-5 text-lg text-white text-opacity-70 dark:text-gray-500">Gestiona tus proyectos mediante tareas y actividades</div>
                </div>
            </div>
            <!-- END: Login Info -->
            <!-- BEGIN: Login Form -->
            <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                <div class="my-auto mx-auto xl:ml-20 bg-white dark:bg-dark-1 xl:bg-transparent px-5 sm:px-8 py-8 xl:p-0 rounded-md shadow-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto">
                    <h2 class="intro-x font-bold text-2xl xl:text-3xl text-center xl:text-left">Ingreso</h2>
                    <div class="intro-x mt-2 text-gray-500 xl:hidden text-center">Control de avances, Administra tus actividades. Gestiona tus proyectos mediante tareas y actividades</div>
                    <div class="intro-x mt-8">
                        <form id="login-form">
                            <input id="email" type="text" class="intro-x login__input form-control py-3 px-4 border-gray-300 block" placeholder="Email" value="fredapg@gmail.com">
                    ...
                    <div class="intro-x flex text-gray-700 dark:text-gray-600 text-xs sm:text-sm mt-4">
                        <div class="flex items-center mr-auto">
                            ...
                            <label class="cursor-pointer select-none" for="remember-me">Recordar ingreso</label>
                        </div>
                    </div>
                    <div class="intro-x mt-5 xl:mt-8 text-center xl:text-left">
                        <button id="btn-login" class="btn btn-primary py-3 px-4 w-full xl:w-32 xl:mr-3 align-top">Ingresar</button>
                        <button id="btn-register" class="btn btn-outline-secondary py-3 px-4 w-full xl:w-32 mt-3 xl:mt-0 align-top">Registro</button>
                    </div>
                    <div class="intro-x mt-10 xl:mt-24 text-gray-700 dark:text-gray-600 text-center xl:text-left">
                        Al ingresar, usted acepta nuestros<br> <a class="text-theme-1 dark:text-theme-10" href="#">Terminos y condiciones</a> y <a class="text-theme-1 dark:text-theme-10" href="#">Politica de privacidad</a>
                    </div>
                </div>
            </div>
            <!-- END: Login Form -->
...
@section('script')
    <script>
        cash(function () {
            ...
            cash('#btn-register').on('click', function(e) {
